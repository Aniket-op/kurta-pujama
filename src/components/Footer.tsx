    ...
    <div className="mx-auto w-full max-w-[1440px] px-4 md:px-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div className="flex flex-col gap-4">
          <Link
            to="/"
            className="font-heading text-[24px] uppercase tracking-widest text-nike-white"
          >
            YOUR LOGO
          </Link>
        </div>
        ...
        {/* Column 2: Categories */}
        <div className="flex flex-col gap-4">
          <h4 className="font-heading text-[18px] uppercase tracking-wider mb-2 text-nike-white">
            Categories
          </h4>
          <Link
            to="/category/kurta-pajama"
            className="font-medium text-[14px] text-nike-secondary-text hover:text-nike-white transition-colors"
          >
            Kurta Pajama
          </Link>
          <Link
            to="/category/ladies-suits"
            className="font-medium text-[14px] text-nike-secondary-text hover:text-nike-white transition-colors"
          >
            Ladies Suits
          </Link>
